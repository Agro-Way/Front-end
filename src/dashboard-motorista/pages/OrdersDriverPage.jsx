	...
	return (
		<div className='flex-1 relative z-10 overflow-auto'>
			...
			<main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
				...
				>
					<StatCard name='Pedidos Totais' icon={ShoppingBag} value={orderStats.totalOrders} color='#6366F1' />
					...
					<StatCard
						...
						color='#10B981'
					/>
					<StatCard name='Faturamento Total' icon={DollarSign} value={orderStats.totalRevenue} color='#EF4444' />
				</motion.div>
